...
const Playground = () => {
    ...
    return (
        <>
            ...
            <section className='dark:bg-lightShade dark:text-darkShade py-32 px-6 gap-4 grid-cont [&>*]:scale-[1] playground-cont overflow-scroll md:overflow-visible [&>*]:overflow-visible mt-10 mb-64 text-[8.2px] sm:px-16 justify-between text-lightShade'>
                {/* popup */}
                {/* popup */}
                {/* popup */}
